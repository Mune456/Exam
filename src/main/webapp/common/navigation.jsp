...
<ul class="nav nav-pills flex-column mb-auto px-4">
	...
	<li class="nav-item mb-3">
		<a href="/exam/scoremanager/main/StudentList.action">学生管理</a>
	</li>
	...
	<li class="nav-item mb-3">
		<a href="/exam/scoremanager/main/SubjectList.action">科目管理</a>
	</li>

	<li class="nav-item mb-3">
		<a href="/exam/scoremanager/main/ClassList.action">クラス管理</a>
	</li>
